...
public class RetriggerPage {
	...
	public void tc1() throws MalformedURLException, InterruptedException {
		...
		retrigger.click();
		Thread.sleep(2000);
		MobileElement retrigger2 = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Submit\"]"));
		retrigger2.click();
		Thread.sleep(2000);
		MobileElement retrigger3 = driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Submit\"]"));
		retrigger3.click();
	}
