...
public class pending_page {
	...
	public void tc1() throws MalformedURLException, InterruptedException {
		...
		pending.click();
		Thread.sleep(2000);
		MobileElement pending2 = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Submit\"]"));
		pending2.click();
		Thread.sleep(2000);
		MobileElement pending3 = driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Submit\"]"));
		pending3.click();
